...
while (<IN1>) { #each sample
	...
	print "write script\n";
	print OUT1 "perl /ifs9/B2C_SGD/PROJECT/MGISEQ-2000_Project/exome_diagnose/exome_cnv/WebServer/src/exonPlot/exonPlot.pl $gene $outpath/coverage/depth.tsv.gz\n";  #20190905
}
